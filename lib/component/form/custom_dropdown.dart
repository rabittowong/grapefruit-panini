...
const double _kMenuItemHeight = kMinInteractiveDimension - 6;
const double _kDenseButtonHeight = 24.0;
const EdgeInsets _kMenuItemPadding = EdgeInsets.symmetric(horizontal: 15.0);
...
const double _kMenuPositionOffsetTop = 46.0;
const double _kMenuPositionOffsetLeft = 54.0;
const double _kMenuListWidthReduce = 78.0;
const double _kSelectedItemOffsetPercentage = 0.0;
const EdgeInsets _kMaterialListPadding = EdgeInsets.zero;
...
class _DropdownMenuRouteLayout<T> extends SingleChildLayoutDelegate {
  ...
  Offset getPositionForChild(Size size, Size childSize) {
    ...
    return Offset(left + _kMenuPositionOffsetLeft, menuLimits.top);
  }
...
class _DropdownRoute<T> extends PopupRoute<_DropdownRouteResult<T>> {
  ...
  _MenuLimits getMenuLimits(
    ...
    final double buttonTop = buttonRect.top + _kMenuPositionOffsetTop;
    final double buttonBottom = math.min(buttonRect.bottom, availableHeight);
    final double selectedItemOffset =
        getItemOffset(index) * _kSelectedItemOffsetPercentage;
